  ...
  Mutation: {
    ...
    saveVendor: async (_, content) => {
      ...
      try {
        ...
        const customerResult = await client.query(saveCustomerQuery.text, saveCustomerQuery.values)
        ...
        const response = {
          ...
          ...customerResult.rows[0], // Include customer data
          ...customerDetailsResult.rows[0], // Include customer details data
          ...customerAddressResult.rows[0], // Include customer address data
          ...customerContactPersonResult.rows[0], //



          addType: customerAddressResult.rows[0].add_type,
          contactFirstName: customerContactPersonResult.rows[0].contact_first_name,
          contactLastName: customerContactPersonResult.rows[0].contact_last_name,
          contactEmail: customerContactPersonResult.rows[0].contact_email,
          contactPhone: customerContactPersonResult.rows[0].contact_phone,
          contactJobRole: customerContactPersonResult.rows[0].contact_job_role,
